						...
						<div class="form-group">
							...
							<select class="form-control" name="jabatan">
								<?php foreach ($jabatan as $key) {
									?>
									<option value="<?php echo $key->id; ?>"><?php echo $key->jabatan; ?></option>
									<?php
								} ?>
							</select>
						</div>
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							foreach ($detail as $dt) {
								if ($dt->id_karyawan == $key->id){
									$idJabatan = $dt->id_jabatan;
								}
							} ?>
							<select class="form-control" name="jabatan">
								<?php foreach ($jabatan as $jb) {
									?>
									<option value="<?php echo $jb->id; ?>"
										<?php if ($jb->id == $idJabatan) {
											echo " selected='selected'";
										} ?>
										><?php echo $jb->jabatan; ?></option>
										<?php
									} ?>
								</select>
							</div>
