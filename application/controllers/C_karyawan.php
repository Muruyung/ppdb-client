...
class C_karyawan extends CI_Controller {
	...
	public function index()
	{
		...
		// $ch = curl_init('http://localhost:62773/api/Karyawan');
		// curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
		// curl_setopt($ch, CURLOPT_URL, 'http://localhost:57940/Karyawan');
		// $result = curl_exec($ch);
		// curl_close($ch);
		// var_dump(json_decode($this->curl->simple_get('http://localhost:62773/api/Karyawan')));
		// var_dump(json_decode($this->curl->simple_get($this->API.'/Karyawan')));
